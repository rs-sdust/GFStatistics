...
{
    public class frmReCorect : XtraForm
    {
        ...
        public static Dictionary<int, ReCorrectElement> RoiLayerDic = new Dictionary<int, ReCorrectElement>();

        private CmdToolReCorrect m_drawElementTool;
        ...
        public frmReCorect()
        {
            ...
            this.btnSaveROI.ToolTip = frmReCorect.MSG06;
            this.btnLoadROI.ToolTip = frmReCorect.MSG03;
            this.btnClearROI.ToolTip = frmReCorect.MSG08;
            this.btnDeleteROI.ToolTip = frmReCorect.MSG09;
            //this.btnAddROI.ToolTip = frmReCorect.MSG10;
            this.chkBtnPolygon.ToolTip = frmReCorect.MSG11;
            this.chkBtnRectangle.ToolTip = frmReCorect.MSG12;
            this.chkBtnSquare.ToolTip = frmReCorect.MSG13;
            this.chkBtnEllipse.ToolTip = frmReCorect.MSG14;
            this.chkBtnCircle.ToolTip = frmReCorect.MSG15;
            //this.m_Color = this.ColorToIColor(this.colorEditROI.Color);
            this.m_drawElementTool = new CmdToolReCorrect();
            this.m_drawElementTool.ROITreeList = this.treeListROILayer;
            this.m_pMapControl = EnviVars.instance.MapControl;
            //this.InitROI(frmReCorect.RoiLayerDic);
        }

        private void frmReCorect_FormClosing(object sender, System.Windows.Forms.FormClosingEventArgs e)
        {
            ...
            //{
            //    System.Windows.Forms.DialogResult dialogResult = XtraMessageBox.Show(frmReCorect.MSG01, "提示信息", System.Windows.Forms.MessageBoxButtons.YesNoCancel, System.Windows.Forms.MessageBoxIcon.Asterisk);
            //    if (dialogResult == System.Windows.Forms.DialogResult.Yes)
            //    {
            //        System.Windows.Forms.SaveFileDialog saveFileDialog = new System.Windows.Forms.SaveFileDialog();
            //        saveFileDialog.Title = frmReCorect.MSG02;
        ...
        private void btnLoadROI_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                openFileDialog.Title = frmReCorect.MSG03;
                openFileDialog.Filter = string.Format("样本{0} (*.sample)|*.sample", "文件");
                if (openFileDialog.ShowDialog(this) == System.Windows.Forms.DialogResult.OK)
                {
                    string fileName = openFileDialog.FileName;
                    this.LoadROI(fileName);
                    string message = string.Format("{0}_{1}", this.Text, frmReCorect.MSG03);
            ...
            catch (Exception ex)
            {
                ...
                Log.WriteLog(typeof(frmReCorect), message);
                Log.WriteLog(typeof(frmReCorect), ex);
        ...
        private void btnSaveROI_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                rasterLyr = MapAPI.GetTopVisableRaster();
                if (rasterLyr == null)
                {
                    XtraMessageBox.Show("读取分类结果文件失败！");
                    return;
                }
                raster2 = rasterLyr.Raster as IRaster2;
                rasterBandCollection = raster2.RasterDataset as IRasterBandCollection;
                rasterBand = rasterBandCollection.Item(0);
                rawPixels = rasterBand as IRawPixels;

                pixelBlockOrigin = new DblPntClass();
                pixelBlockSize = new DblPntClass();
                foreach (TreeListNode node in this.treeListROILayer.Nodes)
                {
                    //calculate element column and row in raster
                    int startColum, startRow, endColum, endRow = -1;
                    ReCorrectElement recorrect = node.Tag as ReCorrectElement;
                    if (recorrect == null)
                        continue;
                    IEnvelope envelope = recorrect.Element.Geometry.Envelope;
                    ...
                    {
                        XtraMessageBox.Show("读取起始行列失败！node:" + node.Id);
                        continue;
                    }
                    ...
                    int nRow = pixelData.GetLength(0);
                    int nCol = pixelData.GetLength(1);
                    foreach (DataRow row in recorrect.CorrectMap.Rows)
                    {
                        ...
                        for (int i = 0; i < nRow; i++)
                            ...
                            {
                                byte oldValue = byte.Parse(row[0].ToString());
                                byte newValue = byte.Parse(row[1].ToString());
                                if (pixelData[i, j] == oldValue)
                                {
                    ...
                    System.Object cachePointer = rawPixels.AcquireCache();
                    rawPixels.Write(pixelBlockOrigin, pixelBlock3 as IPixelBlock);
                    rawPixels.ReturnCache(cachePointer);
                }
                (raster2.RasterDataset as IRasterDataset3).Refresh();
                this.ClearROIElements();
            ...
            {
                if (rasterLyr != null)
                    Marshal.ReleaseComObject(rasterLyr);
                if (raster2 != null)
                    Marshal.ReleaseComObject(raster2);
                if (rasterBandCollection != null)
                    Marshal.ReleaseComObject(rasterBandCollection);
                if (rasterBand != null)
                    Marshal.ReleaseComObject(rasterBand);
                if (rawPixels != null)
                    Marshal.ReleaseComObject(rawPixels);
                if (pixelBlockOrigin != null)
                    Marshal.ReleaseComObject(pixelBlockOrigin);
                if (pixelBlockSize != null)
                    Marshal.ReleaseComObject(pixelBlockSize);
                if (pixelBlock3 != null)
        ...
        //        {
        //            roiNodeName = "ROI #" + num;
        //            rOILayerClass = frmReCorect.RoiLayerDic.Values.FirstOrDefault((ROILayerClass p) => p.Name == roiNodeName);
        //            num++;
        //        }
        ...
        //        int num2 = (frmReCorect.RoiLayerDic.Keys.Count == 0) ? 1 : (frmReCorect.RoiLayerDic.Keys.Max() + 1);
        ...
        //        frmReCorect.RoiLayerDic.Add(num2, rOILayerClass2);
        //        treeListNode.Tag = rOILayerClass2;
        //        this.m_drawElementTool.ROINode = treeListNode;
        //        this.SetControlsEnabled(true);
        //        string message = string.Format("{0}_{1}", this.Text, frmReCorect.MSG10);
        //        //this.m_logger.Log(LogLevel.Info, EventType.UserManagement, message, null);
        //        this.txtROIName.EditValueChanged += new EventHandler(this.txtROIName_EditValueChanged);
        //        this.treeListROILayer.FocusedNodeChanged += new FocusedNodeChangedEventHandler(this.treeListROILayer_FocusedNodeChanged);
        //    }
        ...
        private void btnDeleteROI_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //    }
                    ...
                    //}
                //}
                string message = string.Format("{0}_{1}", this.Text, frmReCorect.MSG09);
                //this.m_logger.Log(LogLevel.Info, EventType.UserManagement, message, null);
            }
            catch (Exception ex)
            {
        ...
        {
            System.Windows.Forms.DialogResult dialogResult = XtraMessageBox.Show(frmReCorect.MSG16, "提示信息", System.Windows.Forms.MessageBoxButtons.YesNo, System.Windows.Forms.MessageBoxIcon.Asterisk);
            if (dialogResult == System.Windows.Forms.DialogResult.Yes)
            {
                this.ClearROIElements();
                this.SetControlsEnabled(false);
        ...
        //
        //switch remap datasource when focusnode changed
        //
        private void treeListROILayer_FocusedNodeChanged(object sender, FocusedNodeChangedEventArgs e)
        {
            if (treeListROILayer.Nodes.Count > 0)
                this.SetControlsEnabled(true);
            else
                this.SetControlsEnabled(false);

            TreeListNode node = this.treeListROILayer.FocusedNode;
            if (node == null)
            {
                this.gridView1.Columns.Clear();
                this.gridValueAndFile.DataSource = NewEmptyMap();
                return;
            }
            ReCorrectElement rec = node.Tag as ReCorrectElement;
            if (null != rec)
            {
                this.gridView1.Columns.Clear();
                this.gridValueAndFile.DataSource = rec.CorrectMap;
                IElement element = rec.Element;
        ...
        //
        //delete node element reorder nodes
        //
        private void barBtnItemDeleteNode_ItemClick(object sender, ItemClickEventArgs e)
        {
            this.m_pMapControl.ActiveView.PartialRefresh(esriViewDrawPhase.esriViewGraphics, null, this.m_pMapControl.ActiveView.Extent);
            TreeListNode focusedNode = this.treeListROILayer.FocusedNode;
            ReCorrectElement reCorrectElement = focusedNode.Tag as ReCorrectElement;
            if (reCorrectElement.Checked)
            {
                reCorrectElement.Checked = false;
                if (this.IsExistElement(reCorrectElement.Element))
                {
                    this.m_pMapControl.ActiveView.GraphicsContainer.DeleteElement(reCorrectElement.Element);
                }
            }
        ...
        private void treeListROILayer_AfterCheckNode(object sender, NodeEventArgs e)
        {
            ...
            if (e.Node.CheckState == System.Windows.Forms.CheckState.Unchecked)
            {
                    ...
                    this.DeleteElements((e.Node.Tag as ReCorrectElement));

            }
            else
            {
                this.AddElements(e.Node.Tag as ReCorrectElement);
            }
            this.m_pMapControl.ActiveView.PartialRefresh(esriViewDrawPhase.esriViewGraphics, null, this.m_pMapControl.ActiveView.Extent);
        }
        ...
        //        frmReCorect.RoiLayerDic[key].Color = color;
        //        this.m_pMapControl.ActiveView.PartialRefresh(esriViewDrawPhase.esriViewGraphics, null, this.m_pMapControl.ActiveView.Extent);
        //        foreach (ROIElementClass current in frmReCorect.RoiLayerDic[key].ElementList)
        //        {
        ...
        public void InitROI(Dictionary<int, ReCorrectElement> roiLayerDic)
        {
            if (roiLayerDic != null)
            {
                ...
                foreach (KeyValuePair<int, ReCorrectElement> current in roiLayerDic)
                {
                    TreeListNode treeListNode = this.treeListROILayer.AppendNode(new object[]
					{
						current.Value.ID
                    ...
                    //{
                        ...
                        if (this.IsExistElement(current.Value.Element))
                        {
                            current.Value.Checked = true;
                        }
                        else
                        {
                            current.Value.Checked = false;
                            //list.Add(rOIElementClass);
                        }
                    //    System.Windows.Forms.CheckState checkState = current.Value.Checked ? System.Windows.Forms.CheckState.Checked : System.Windows.Forms.CheckState.Unchecked;
        ...
        private void LoadROI(string xmlPath)
        {
            ...
            if (!string.IsNullOrEmpty(xmlPath) && File.Exists(xmlPath))
            {
                ...
                for (int i = 0; i < xmlNode.ChildNodes.Count; i++)
                {
                    ...
                    reCorrectElement.ID = ((frmReCorect.RoiLayerDic.Keys.Count == 0) ? 1 : (frmReCorect.RoiLayerDic.Keys.Max() + 1));
                    //reCorrectElement.Element = new List<ROIElementClass>();
                    frmReCorect.RoiLayerDic.Add(reCorrectElement.ID, reCorrectElement);
        ...
        private void SetROINodeInfo()
        {
            ...
            {
                TreeListNode treeListNode = (this.treeListROILayer.FocusedNode.Level == 0) ? this.treeListROILayer.FocusedNode : this.treeListROILayer.FocusedNode.ParentNode;
                ReCorrectElement reCorrectElement = treeListNode.Tag as ReCorrectElement;
                //this.m_drawElementTool.ParentNodeID = reCorrectElement.ID;
                this.m_drawElementTool.ROINode = this.treeListROILayer.FocusedNode;
                //this.txtROIID.Text = reCorrectElement.ID.ToString();
                //this.txtROIName.Text = reCorrectElement.Name;
        ...
        private void SaveROIToXml(string savePath)
        {
            ...
            foreach (TreeListNode treeListNode in this.treeListROILayer.Nodes)
            {
                if (treeListNode.CheckState != System.Windows.Forms.CheckState.Unchecked)
                {
                    ...
                    ReCorrectElement rOILayerClass = treeListNode.Tag as ReCorrectElement;
                    ...
                    XmlNode xmlNode5 = this.CreatePolygonNode(xmlDocument, rOILayerClass.Element);
        ...
        private void DeleteElements(ReCorrectElement reCorrectElement)
        {
        ...
        private void AddElements(ReCorrectElement roiElement)
        {
        ...
        {
            this.m_pMapControl.ActiveView.PartialRefresh(esriViewDrawPhase.esriViewGraphics, null, this.m_pMapControl.ActiveView.Extent);
            foreach (KeyValuePair<int, ReCorrectElement> current in frmReCorect.RoiLayerDic)
            {
                if (current.Value.Checked)
                {
                    ...
                    if (this.IsExistElement(current.Value.Element))
                    {
                        this.m_pMapControl.ActiveView.GraphicsContainer.DeleteElement(current.Value.Element);
                    }
                }
            }
            this.m_pMapControl.ActiveView.PartialRefresh(esriViewDrawPhase.esriViewGraphics, null, this.m_pMapControl.ActiveView.Extent);
        ...
        private void ClearROIElements()
        {
            try
            {
                ...
                this.gridView1.Columns.Clear();
                this.gridValueAndFile.DataSource = this.NewEmptyMap();
                string message = string.Format("{0}_{1}", this.Text, frmReCorect.MSG08);
                //this.m_logger.Log(LogLevel.Info, EventType.UserManagement, message, null);
            }
            catch (Exception ex)
            {
        ...
        {
            if (treeListROILayer.FocusedNode == null)
                return false;
            ReCorrectElement reCorrectElement = treeListROILayer.FocusedNode.Tag as ReCorrectElement;
            if (!frmReCorect.RoiLayerDic.ContainsKey(reCorrectElement.ID))
            {
                XtraMessageBox.Show(frmReCorect.MSG05, "提示信息", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Asterisk);
                return false;
            }
            else
            {
        ...
        private void DeleteFocusNode()
        {
            if (treeListROILayer.FocusedNode == null)
                return ;
            TreeListNode treeListNode = treeListROILayer.FocusedNode;
            ReCorrectElement reCorrectElement = treeListNode.Tag as ReCorrectElement;
            if (reCorrectElement.Checked)
            {
                reCorrectElement.Checked = false;
                ...
                frmReCorect.RoiLayerDic.Remove(reCorrectElement.ID);
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmReCorect));
            ...
            this.splitContainerControl1.Panel2.Controls.Add(this.gridValueAndFile);
            ...
            this.treeListROILayer.Size = new System.Drawing.Size(210, 384);
            ...
            this.btnSaveROI.Location = new System.Drawing.Point(11, 10);
            ...
            this.btnClearROI.Location = new System.Drawing.Point(72, 10);
            ...
            this.btnDeleteROI.Location = new System.Drawing.Point(41, 10);
            ...
            this.gridValueAndFile.Location = new System.Drawing.Point(17, 76);
            this.gridValueAndFile.MainView = this.gridView1;
            this.gridValueAndFile.Name = "gridValueAndFile";
            this.gridValueAndFile.Size = new System.Drawing.Size(279, 349);
            this.gridValueAndFile.TabIndex = 14;
            ...
            //this.chkBtnPolygon.CheckedChanged += new System.EventHandler(this.chkBtnPolygon_CheckedChanged);
            ...
            this.Name = "frmReCorect";
            this.ShowIcon = false;
            this.ShowInTaskbar = false;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
            this.Text = "分类后校正";
            this.HelpButtonClicked += new System.ComponentModel.CancelEventHandler(this.frmReCorect_HelpButtonClicked);
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.frmReCorect_FormClosing);
